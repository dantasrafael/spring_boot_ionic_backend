...
import com.udemy.spring_boot_ionic_backend.domain.Pagamento;
import com.udemy.spring_boot_ionic_backend.domain.PagamentoComBoleto;
import com.udemy.spring_boot_ionic_backend.domain.PagamentoComCartao;
import com.udemy.spring_boot_ionic_backend.domain.Pedido;
import com.udemy.spring_boot_ionic_backend.domain.Produto;
...
import com.udemy.spring_boot_ionic_backend.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "rafael.dantas.exesistemas@gmail.com", "67851287227", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli1.getTelefones().addAll(Arrays.asList("54321", "123"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "dantasrafael@yahoo.com.br", "21222537702", TipoCliente.PESSOAFISICA, pe.encode("123"));		
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("12345", "332"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida centro", "222", null, "Centro", "21345675", cli2, c2);
